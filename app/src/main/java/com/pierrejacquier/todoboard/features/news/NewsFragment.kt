...
//import com.pierrejacquier.todoboard.features.news.adapter.DevicesAdapter
...
//            (news_list.adapter as DevicesAdapter).clearAndAddDevices(redditNews!!.news)
//        } else {
//            requestNews()
//        }
//    }
...
//        val news = (news_list.adapter as DevicesAdapter).getDevices()
...
//            news_list.adapter = DevicesAdapter()
//        }
//    }
//
//    fun requestNews() {
//        val subscription = newsManager.getDevices(redditNews?.after ?: "")
//                .subscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe({retrievedNews ->
//                    redditNews = retrievedNews
//                    (news_list.adapter as DevicesAdapter).addNews(retrievedNews.news)
//                }, { e ->
